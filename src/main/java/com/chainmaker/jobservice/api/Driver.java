...
//                "JOIN CDATA ON ADATA.A2=CDATA.C2 WHERE BDATA.B1>3 AND ADATA.A2<10";
        String query = "SELECT ADATA.A1, TABLEC.C1 FROM (ADATA JOIN BDATA ON ADATA.A1=BDATA.B1) JOIN TABLEC ON ADATA.A2=TABLEC.C2 WHERE TABLEC.ID < 20 AND BDATA.B1 > 10";
