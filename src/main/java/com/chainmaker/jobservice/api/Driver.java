...
//                "JOIN CDATA ON ADATA.A2=CDATA.C2 WHERE BDATA.B1>3 AND ADATA.A2<10";
        String query = "SELECT BDATA.B1, ADATA.A2, TABLEC.C1 FROM ((ADATA JOIN BDATA ON ADATA.A1=BDATA.B1) JOIN TABLEC ON ADATA.A2=TABLEC.C2) JOIN CDATA ON ADATA.ID=CDATA.ID";
