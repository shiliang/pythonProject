...
//        String query = "SELECT WYC_DATA.DATA+JTW_DATA.DATA FROM WYC_DATA,DT_DATA,JTW_DATA WHERE WYC_DATA.ID=DT_DATA.ID AND WYC_DATA.ID=JTW_DATA.ID";

//        String query = "SELECT ATEST1.ID FROM ATEST1,BTEST1,CTEST1 WHERE ATEST1.ID=BTEST1.ID AND ATEST1.ID=CTEST1.ID";
        String query = "SELECT T_DT_USER.DATA,T_DT_USER.ID FROM T_DT_USER WHERE T_DT_USER.ID=?";
