...
//        String query = "select adata.a1, bdata.b2 from adata, bdata";
//        String query = "SELECT SUM(ADATA.A1+BDATA.B2) FROM ADATA JOIN BDATA ON ADATA.A2=BDATA.B2 WHERE BDATA.B1>3";
//        String query = "select adata.a1 from adata join bdata on adata.a1=bdata.b1 where adata.a1 > 4 and adata.a2 > 50";
