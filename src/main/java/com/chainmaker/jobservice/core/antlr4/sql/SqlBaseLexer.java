...
public class SqlBaseLexer extends Lexer {
	...
	public static final int
		...
		SIMPLE_COMMENT=253, BRACKETED_COMMENT=254, WS=255, UNRECOGNIZED=256;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "T__6", "FL", "FLLABEL", 
			"INTERSECTION", "HEFB", "HEFSL", "HEFSP", "HEFSC", "HEDS", "HESB", "HOSB", 
			"HELR", "HEKMS", "HELNR", "EVAL", "SELECT", "FROM", "ADD", "AS", "ALL", 
			...
			"UNION", "EXCEPT", "SETMINUS", "INTERSECT", "TO", "TABLESAMPLE", "STRATIFY", 
			"ALTER", "RENAME", "ARRAY", "MAP", "STRUCT", "COMMENT", "SET", "RESET", 
			"DATA", "START", "TRANSACTION", "COMMIT", "ROLLBACK", "MACRO", "IF", 
			"EQ", "NSEQ", "NEQ", "NEQJ", "LT", "LTE", "GT", "GTE", "PLUS", "MINUS", 
			"ASTERISK", "SLASH", "PERCENT", "DIV", "TILDE", "AMPERSAND", "PIPE", 
			"HAT", "RSHIFT", "PERCENTLIT", "BUCKET", "OUT", "OF", "SORT", "CLUSTER", 
