...
import com.chainmaker.jobservice.api.serdeser.TimeFieldAndIdFieldFilterSerializer;
...
//            "SELECT FE(model_name=HESCALE, features=[atest_1.*,btest_2.*]),TRAIN(model_name='HELR',label=btest_2.k, features= [atest_1.*,btest_2.*]) From atest_1, btest_2 WHERE atest_1.id = btest_2.id",
    ...
    public static void main(String[] args) {
        ...
        for(String pql: pqls){
            ...
            CustomDelimiterKVStore.put(storeKey, JSON.toJSONString(job.getTaskList(), new TimeFieldAndIdFieldFilterSerializer()));
        }
