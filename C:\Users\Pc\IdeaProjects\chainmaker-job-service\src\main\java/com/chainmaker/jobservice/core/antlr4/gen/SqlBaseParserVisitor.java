...
public interface SqlBaseParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code federatedQueryExpression}
	 ...
	 * @return the visitor result
	 */
	T visitFlExpressionSeq(SqlBaseParser.FlExpressionSeqContext ctx);
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#flExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFlExpression(SqlBaseParser.FlExpressionContext ctx);
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#flOperator}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFlOperator(SqlBaseParser.FlOperatorContext ctx);
	/**
