// Generated from /Users/kevin/IdeaProjects/chainmaker-job-service/src/main/java/com/chainmaker/jobservice/core/antlr4/SqlBaseParser.g4 by ANTLR 4.13.1
...
public interface SqlBaseParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code federatedQueryExpression}
	 * labeled alternative in {@link SqlBaseParser#namedExpressionSeq}.
	 * @param ctx the parse tree
	 */
	void enterFederatedQueryExpression(SqlBaseParser.FederatedQueryExpressionContext ctx);
	/**
	 * Exit a parse tree produced by the {@code federatedQueryExpression}
	 * labeled alternative in {@link SqlBaseParser#namedExpressionSeq}.
	 * @param ctx the parse tree
	 */
	 ...
	 * @param ctx the parse tree
	 */
	void enterFlType(SqlBaseParser.FlTypeContext ctx);
	/**
	 * Exit a parse tree produced by {@link SqlBaseParser#flType}.
	 * @param ctx the parse tree
	 */
	 ...
	 * @param ctx the parse tree
	 */
	void enterFlExpressionSeq(SqlBaseParser.FlExpressionSeqContext ctx);
	/**
	 * Exit a parse tree produced by {@link SqlBaseParser#flExpressionSeq}.
	 * @param ctx the parse tree
	 */
	void exitFlExpressionSeq(SqlBaseParser.FlExpressionSeqContext ctx);
	/**
	 * Enter a parse tree produced by {@link SqlBaseParser#flExpression}.
	 * @param ctx the parse tree
	 */
	void enterFlExpression(SqlBaseParser.FlExpressionContext ctx);
	/**
	 * Exit a parse tree produced by {@link SqlBaseParser#flExpression}.
	 * @param ctx the parse tree
	 */
	void exitFlExpression(SqlBaseParser.FlExpressionContext ctx);
	/**
	 * Enter a parse tree produced by {@link SqlBaseParser#flOperator}.
	 * @param ctx the parse tree
	 */
	void enterFlOperator(SqlBaseParser.FlOperatorContext ctx);
	/**
	 * Exit a parse tree produced by {@link SqlBaseParser#flOperator}.
	 * @param ctx the parse tree
	 */
	void exitFlOperator(SqlBaseParser.FlOperatorContext ctx);
	/**
